                        ...
                        <div className="flex justify-between items-start">
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              {item.oldPrice && (
                                <>
                                  <p className="text-[10px] text-gray-400 line-through font-medium">{item.oldPrice}</p>
                                  {item.discountPercentage && (
                                    <span className="text-[8px] bg-[#D4AF37]/10 text-[#D4AF37] px-1.5 py-0.5 rounded-md font-bold">
                                      -{item.discountPercentage}%
                                    </span>
                                  )}
                                </>
