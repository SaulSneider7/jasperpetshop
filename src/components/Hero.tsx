...
export const Hero = () => {
  return (
    <section id="inicio" className="relative min-h-[70vh] flex items-center pt-32 pb-20 overflow-hidden">
      {/* Background Accents */}
      ...
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-7" data-aos="fade-right">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold leading-[1.1] mb-6 tracking-tighter">
            Confort <br />
            <span className="text-[#B59410] italic">Real</span> para <br />
            tu Mascota.
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <button className="bg-[#1a1a1a] text-white px-8 py-4 rounded-xl flex items-center gap-3 hover:bg-[#B59410] transition-all group shadow-xl shadow-black/10">
            ...
            <div className="flex -space-x-2 items-center">
              ...
              <div className="pl-4">
                ...
                <div className="flex gap-0.5">
                  {[1, 2, 3, 4, 5].map((s) => <FontAwesomeIcon key={s} icon={faStar} className="text-[#B59410] text-[6px]" />)}
                </div>
              </div>
            </div>
          </div>
